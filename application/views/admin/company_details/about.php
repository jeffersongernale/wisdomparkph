    ...
    <div id="accordion">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <fieldset class="border pb-3 pr-3 pl-3 mb-4">
                                ...
                                <p class="card-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Wisdom Park is a project initiative of the Universal Wisdom Foundation, Inc.
                                </p>
                            </fieldset>
                ...
                <div class="card-body">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <fieldset class="border pb-3 pr-3 pl-3 mb-4">
                                <legend class="w-auto font-weight-bold pl-2 pr-2"><i class="fa fa-database"></i>&nbsp;Current</legend>
                                <p class="card-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; In 1989, a group of people, propelled by the goal to continuously enhance and inculcate human values in the hearts and minds of every individual, joined resources and came up with a Buddhist Resource Center. As a result, WP was born, designed to be a home for Buddhist-inspired activities promoting human values in Education.
                                </p>
                            </fieldset>
        ...
        <div class="card">
            <div class="card-header p-1  accordion_header" id="headingThree" data-toggle="collapse" data-target="#collapse_subdetails" aria-expanded="false" aria-controls="collapseThree">
                <h6 class="mb-0  p-1">
                    <i class="fa fa-clipboard-list"></i>&nbsp;SUB-DETAILS
                </h6>
            </div>
        ...
        <div class="card">
            <div class="card-header p-1 accordion_header" id="headingThree" data-toggle="collapse" data-target="#collapse_image" aria-expanded="false" aria-controls="collapseThree">
                <h6 class="mb-0  p-1">
                    <i class="fa fa-image"></i>&nbsp;IMAGE
                </h6>
            </div>
            <div id="collapse_image" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                <div class="card-body">
