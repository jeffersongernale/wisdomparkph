...
<html lang="en">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="mb-0 text-nowrap"><img class="img-responsive logo" src="asset/images/LOGO/LOGO.png">Wisdom Park</a></h1>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li><a href="#mission_vision-section" class="nav-link">Mission and Vision</a></li>
                    <li><a href="#goal-section" class="nav-link">Our Goals</a></li>
    ...
    <!-- ABOUT -->
    <section class="site-section cta-big-image" id="about-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade">
            <h2 class="section-title mb-3">All About Us</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-3 mb-5" data-aos="fade-up" data-aos-delay="">
            <figure class="circle-bg">
            <img src="asset/images/WP buddha.jpg" alt="Image" class="img-fluid">
            </figure>
          </div>
          <div class="col-lg-8 ml-auto" data-aos="fade-up" data-aos-delay="100">
            <div class="mb-4">
              <h3 class="h3 mb-4 text-black">Wisdom Park is a project initiative of the Universal Wisdom Foundation, Inc. </h3>
            ...
            <div class="mb-4">
              <ul class="list-unstyled ul-check success">
                <li></li>
                <li>The mainstream activities in this Center comprise of lectures on Buddhism, Science, Philosophy, Psychology, Health, and the Environment.</li>
                <li>The Center is equipped with multi-media facilitation rooms designed to continuously conduct programs, lectures, and dialogues relevant to the abovementioned goal.</li>
                <li>Licensed counselors for troubled individuals and community service activities are also available. </li>
              </ul>
    ...
    <!-- MISSION VISION -->
    <section class="site-section bg-light" id="mission_vision-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade">
        ...
        <div class="row">
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <div class="mb-4">
               <ul class="list-unstyled ul-check success">
                <li>
                  <h3 class="h3 mb-2 text-black">MISSION</h3>
                  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To make Buddhism in daily life work for the betterment of individual and the society as a whole. And to continuously promote Buddhism as a Philosophy, Way of Life and continuing education. </p>
                </li>
                <li class="mt-5">
                  <h3 class="h3 mb-2 text-black">VISION</h3>
                  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To grow as a non-stock, non-profit organization & to provide the public quality humanitarian services guided by the teachings of Buddhism.</p>
                </li>
              </ul>
            </div>
          </div>
    ...
    <!-- GOAL -->
    <section class="site-section" id="goal-section">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center" data-aos="fade">
        ...
        <div class="row">
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="100">
            <div class="mb-4">
              <ul class="list-unstyled ul-check success">
                <li>To provide guidance to individuals from all walks life to attain quality life.</li>
                <li>To reach out marginalized sector of the society and be able to instill the importance of human values and virtues to compassion and goodwill.</li>
                <li>To continuously conduct relevant programs, lectures and dialogues.</li>
                <li>To provide individuals free educational materials and make use of its library and facilities for their personal enhancement.</li>
                <li>To foster a strong linkage between Buddhist and other inter-religious organizations.</li>
                <li>To serve as a communication to other Buddhist organizations around the world.</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section class="site-section border-bottom bg-light" id="events-section">
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-8 text-center">
            <h2 class="section-title mb-3" data-aos="fade-up" data-aos-delay="">Our Events</h2>
            <p class="lead" data-aos="fade-up" data-aos-delay="100">Come and visit us with these upcoming events</p>
          </div>
        </div>
        <div class="row">
