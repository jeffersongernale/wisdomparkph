        ...
        <div id="posts" class="row no-gutter gallery_container">
          ...
          if(count($videos) > 0)
          {
            foreach($videos as $videos_val)
            {
              echo "<div class='item videos col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4'>
                      <a href='https://www.youtube.com/embed/{$videos_val['image_name']}?' class='item-wrap fancybox' data-fancybox='gallery2'>
                      <span class='icon-search2'></span>
                      <iframe width='420' height='315' class='img-fluid'
                      src='https://www.youtube.com/embed/{$videos_val['image_name']}?'>
                      </iframe>
                      </a>
                  </div>";
            }
          ...
          if(count($songs) > 0)
          {
            foreach($songs as $songs_val)
            {
              ...
              echo "<div class='item songs col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-4'>
                      <div class='audio_cont pl-3 pb-5 pr-3 pt-2'>
                        <div class='text-center font-weight-bold text-uppercase' style='background-color:#532782; color: white; border: solid 3px #d4bdfc; border-radius: 30px; font-size : 12px;'>
                        {$songs_val['description']}
                        </div>
